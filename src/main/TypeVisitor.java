...
// ********************* ESTHER/TYLER TESTS, DELETE ME ******************************* \\

	private static int declarationCounter = 0; // count of only the type declarations
	private static int referenceCounter = 0; // count of all the identifiers except for the type declarations
...
// ********************* ESTHER TESTS, DELETE ME ******************************* \\
	...
	// 		if (binding.getQualifiedName().equals(type) || binding.getName().equals(type))
	// 		{
...
// ********************* TYLER TESTS, DELETE ME ******************************* \\
// ********************* JOSH TESTS, DELETE ME ******************************* \\
public boolean visit(TypeDeclaration node) {
				String nodeName = node.getName().getFullyQualifiedName();
				if(nodeName.equals(type)) declarationCounter++;
				return true;
			}
			...
			public boolean visit(EnumDeclaration node) {
				...
				if(typeNode.equals(type)) declarationCounter++;
			 ...
			 */
			public boolean visit(QualifiedName node) {
				if(node.getFullyQualifiedName().equals(type)) referenceCounter++;
				return false;
			}
			...
			public boolean visit(VariableDeclarationFragment node) {
				...
				if(typeNode.equals(type)) referenceCounter++;
				return false;
}
// ********************* JOSH TESTS, DELETE ME ******************************* \\
